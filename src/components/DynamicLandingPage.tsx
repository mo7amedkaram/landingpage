                    ...
                    <div className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                <motion.div
                                    variants={fadeUp}
                                    className="text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight mb-6 rich-text-content"
                                ...
                                <motion.div
                                    variants={fadeUp}
                                    className="text-lg md:text-xl mb-6 leading-relaxed rich-text-content"
                                ...
                                <motion.ul variants={fadeUp} className="space-y-3 mb-8">
                                    {content.hero.bullets.map((item, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <Check className="w-5 h-5 mt-1 flex-shrink-0" style={{ color: accentColor }} />
                                ...
                                <motion.div variants={fadeUp}>
                                    <Button
                                        ...
                                        className="text-lg px-8 py-6 h-auto shadow-xl hover:shadow-2xl animate-pulse hover:animate-none"
                            ...
                            >
                                <div className="relative">
                                    {content.hero.heroImage ? (
                                        ...
                                        <div className="aspect-square rounded-3xl flex items-center justify-center shadow-2xl" style={{ background: `linear-gradient(135deg, ${secondaryAccent}20, ${secondaryAccent}40)` }}>
                                            <div className="text-center p-8">
                                                <Heart className="w-24 h-24 mx-auto mb-4" style={{ color: heroCta }} />
                                                <p className="text-2xl font-bold text-slate-700">دورة الإسعافات الأولية</p>
                                                <p className="mt-2" style={{ color: secondaryAccent }}>3 أيام • عملي 100%</p>
                                            </div>
                                        </div>
                                    )}
                                    <div className="absolute -bottom-4 -right-4 text-white px-4 py-2 rounded-full shadow-lg font-bold" style={{ backgroundColor: accentColor }}>
                                        مجاناً!
                                    </div>
                                </div>
                            </motion.div>
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                        ...
                                        <div className="relative py-2">
                                            ...
                                            <div className="relative flex justify-center">
                                                <span className="bg-white px-4 text-sm text-slate-500 flex items-center gap-2">
